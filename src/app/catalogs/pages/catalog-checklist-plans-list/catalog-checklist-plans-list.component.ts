...
@Component({
  ...
  templateUrl: './catalog-checklist-plans-list.component.html',
  animations: [ routingAnimation, dissolve, ],
  styleUrls: ['./catalog-checklist-plans-list.component.scss']
})
export class CatalogChecklistPlansListComponent implements AfterViewInit {
